    ...
    <div class="box-header with-border">
        ...
        <div class="box-tools">
            <div class="btn-group pull-right" style="margin-right: 10px">
                <a href="{{url(config('admin.prefix').'/auth/user')}}" class="btn btn-sm btn-default"><i class="fa fa-list"></i>&nbsp;列表</a>
            </div> 
            <div class="btn-group pull-right" style="margin-right: 10px">
    ...
    <form id="addForm" method="post" action="" class="form-horizontal">
        ...
        <div class="box-footer">
            ...
            <div class="btn-group col-md-8">
                ...
                <button id="edit_button" type="submit" class="btn btn-info pull-right">提交</button>
            </div>
        </div>
    </form>
    <!-- END FORM-->
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.status == 1) {
                        ...
                        location.href = "{{url(config('admin.prefix')).'/auth/user'}}";
                    } else {
